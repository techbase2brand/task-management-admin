...
const AddProject: React.FC = (navigation) => {
  ...
  const handleAddProject = () => {
    ...
    if (projEditObj) {
      console.log(projEditObj.ProID, "5555----");
      ...
      axios
        .put(`http://localhost:5000/updateProject/${projEditObj.ProID}`, data)
        .then((response: any) => {
          console.log(data.projectDescription, "7777---gg");

          console.log(response.data, "999gggggg-----");
